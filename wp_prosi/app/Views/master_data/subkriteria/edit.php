        ...
        <div class="card-body">
            ...
            <form class="row g-3" method="post" action="<?= base_url($controller . '/update//' . $row->id); ?>">
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="subkriteria" name="subkriteria" value="<?= $row->id; ?>" disabled>
                </div>
                <div class="col-12">
                    <label for="kriteria" class="form-label">Kriteria</label>
                    <select name="kriteria" id="kriteria" class="form-select">
                        <option value="<?= $row->id_kriteria; ?>"><?= $row->kriteria_kriteria; ?></option>
                ...
                <div class="col-12">
                    <label for="subkriteria" class="form-label">Subriteria</label>
                    <input type="text" class="form-control" id="subkriteria" name="subkriteria" value="<?= $row->subkriteria; ?>">
                </div>
                <div class="col-12">
                    <label for="skor" class="form-label">Skor</label>
                    <select name="skor" id="skor" class="form-select">
                        <option value="<?= $row->id_tingkat_bobot_kriteria; ?>"><?= $row->nilai_tingkat_bobot_kriteria; ?></option>
