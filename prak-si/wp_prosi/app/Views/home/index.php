<div class="pagetitle">
    ...
    <nav class="d-flex justify-content-end">
        <ol class="breadcrumb">
            <li class="breadcrumb-item active"><a href="<?= base_url(); ?>"><?= $title; ?></a></li>
        </ol>
    </nav>
</div><!-- End Page Title -->
...
<section class="section profile">
            ...
            <div class="card-body pt-3">
                <div class="tab-content pt-2">
                    ...
                    <div class="tab-pane fade show active profile-overview" id="profile-overview">
                        ...
                        <div class="row">
                            <div class="col-md-3 label ">Mata Kuliah</div>
                            <div class="col-md-9 ">Praktikum Sistem Informasi</div>
                        </div>
                        <div class="row">
                            <div class="col-md-3 label ">Dosen Pengampu</div>
                            <div class="col-md-9 ">Allin Junikhah, M.T.</div>
                        </div>
                        <div class="row">
                            <div class="col-md-3 label ">Kelas</div>
                            <div class="col-md-9 ">E</div>
                        </div>
                        <div class="row">
                            <div class="col-md-3 label "></div>
                            <div class="col-md-9 ">Proyek UAS Semester Ganjil 2023</div>
                        </div>
    ...
    <div class="breadcrumb">
        <span class="breadcrumb-item active">Anggota Kelompok</span>
    </div>
        ...
        <div class="col-xl-4">
            ...
            <div class="card">
                <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                    ...
                    <img src="img/prosi/suci.png" alt="Profile" class="rounded-circle">
                    <h2>Suci Wulandari</h2>
                    <h3 class="pt-2">NIM 210605110154</h3>
        ...
        <div class="col-xl-4">
            ...
            <div class="card">
                <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                    ...
                    <img src="img/prosi/alroy.png" alt="Profile" class="rounded-circle">
                    <h2>Alroy Rasyid Resan</h2>
                    <h3 class="pt-2">NIM 200605110013</h3>
                    <div class="social-links mt-2">
                        <a href="javascript:void(0);" class="twitter"><i class="bi bi-twitter"></i></a>
                        <a href="javascript:void(0);" class="facebook"><i class="bi bi-facebook"></i></a>
                        <a href="javascript:void(0);" class="instagram"><i class="bi bi-instagram"></i></a>
...
<section class="section contact">
    ...
    <div class="breadcrumb">
        <span class="breadcrumb-item active">Teknologi</span>
    </div>
            ...
            <div class="row d-flex justify-content-center">
                ...
                <div class="col-lg-4">
                    <div class="info-box card">
                        <image src="img/apple-touch-icon.png" style="height: auto; width: 10rem;" />
                        <a href="https://bootstrapmade.com/nice-admin-bootstrap-admin-html-template/" target="_blank">
                            <h3>Nice Admin <i class="bi bi-arrow-up-right-square ps-1" style="font-size: 1.5rem;"></i></h3>
                        </a>
                        <p>NiceAdmin is a powerful admin and dashboard template based latest version of Bootstrap framework.</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="info-box card">
                        <image src="https://www.javascript.com/etc.clientlibs/pluralsight/clientlibs/clientlib-main/resources/images/js-logo.png" style="height: auto; width: 10rem;" class="bg-dark p-3" />
                        <a href="https://bootstrapmade.com/nice-admin-bootstrap-admin-html-template/" target="_blank">
                            <h3>JavaScript <i class="bi bi-arrow-up-right-square ps-1" style="font-size: 1.5rem;"></i></h3>
                        </a>
                        <p>JavaScript.com is a resource built by the Pluralsight team for the JavaScript community.
                            Because JavaScript is a great language for coding beginners, we've gathered some of the best learning resources around and built a JavaScript course to help new developers get up and running.</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="info-box card">
                        <image src="https://www.php.net/images/logos/php-logo.svg" style="height: auto; width: 10rem;" />
                        <a href="https://www.php.net/" target="_blank">
                            <h3>PHP <i class="bi bi-arrow-up-right-square ps-1" style="font-size: 1.5rem;"></i></h3>
                        </a>
                ...
                <div class="col-lg-4">
                    <div class="info-box card">
                        <svg role="img" aria-label="Visit CodeIgniter.com official website!" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2100 500" height="auto" width="10rem">
                        ...
                        <a href="https://codeigniter.com/" target="_blank">
                            <h3>CodeIgniter <i class="bi bi-arrow-up-right-square ps-1" style="font-size: 1.5rem;"></i></h3>
                        </a>
                ...
                <div class="col-lg-4">
                    <div class="info-box card">
                        <image src="https://mariadb.org/wp-content/themes/twentynineteen-child/icons/logo_seal.svg" style="height: auto; width: 10rem;" />
                        <a href="https://mariadb.org/" target="_blank">
                            <h3>MariaDB <i class="bi bi-arrow-up-right-square ps-1" style="font-size: 1.5rem;"></i></h3>
                        </a>
                        <p>MariaDB Server is one of the most popular open source relational databases. It’s made by the original developers of MySQL and guaranteed to stay open source. It is part of most cloud offerings and the default in most Linux distributions.</p>
                    </div>
                </div>
